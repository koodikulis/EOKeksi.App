namespace EOKeksi
{
    internal class Misfortune
    {
        ...
        {"Soittamalla Metallican kill em all -levyä keskellä yötä saa naapurisi tuomaan sinulle epäonnea aamulla.",
         ...
         "Kissanruoka loppuu, josta suuttuneena kissa raapii pilalle tapettisi",
         ...
         "Maistat lempituotteesi uutuusmakua. Se ei maistu hyvältä eikä huonolta."
